...
\title{Visualizing Low-Dimensional Word Embeddings with Emoji Annotations}
...
%% Abstract section.
\abstract{Word embeddings are quite a buzz in today's time in the lingusitics community, mainly because of their excellent performance in NLP applications like machine translation, topic modelling, question answering, etc. But when we try to look at the visualizations of these embeddings, we don't seem to get any sort of take-home knowledge from that. We propose 2D visualizations of these embeddings by using a clustering algorithm, and to have these clusters express their semantic information in a more understandable way, we annotate these clusters with emojis. %
} % end of abstract
